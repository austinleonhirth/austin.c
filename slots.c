...
void slots_f() {
    ...
    printf(INFO"Starting \"The Gameington: Slots Edition\" setup process\n");
    ...
    int run_status = system(strcat(thegameington_path,"/game slots"));
    if (run_status != 0) {
        printf("\n"ERROR"Process crashed (or executable not found)\n");
    }

    printf("\n"INFO"Finished running The Gameington: Slots Edition\n\n");
